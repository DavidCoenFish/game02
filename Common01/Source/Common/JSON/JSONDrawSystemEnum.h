...
NLOHMANN_JSON_SERIALIZE_ENUM( D3D12_SRV_DIMENSION, {
   ...
   {D3D12_SRV_DIMENSION_TEXTURE2D, "D3D12_SRV_DIMENSION_TEXTURE2D"},
   {D3D12_SRV_DIMENSION_TEXTURE2DARRAY, "D3D12_SRV_DIMENSION_TEXTURE2DARRAY"},
   {D3D12_SRV_DIMENSION_TEXTURE2DMS, "D3D12_SRV_DIMENSION_TEXTURE2DMS"},
   {D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY, "D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY"},
   ...
   {D3D12_SRV_DIMENSION_RAYTRACING_ACCELERATION_STRUCTURE, "D3D12_SRV_DIMENSION_RAYTRACING_ACCELERATION_STRUCTURE"}
});
